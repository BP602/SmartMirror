...
class NoteRepository extends EventEmitter {
  constructor () {
    super()
    this.ref = new Firebase('https://smart-mirror.firebaseio.com/notes') // will have same result as new Firebase('https://<YOUR-FIREBASE-APP>.firebaseio.com/').child('notes')
